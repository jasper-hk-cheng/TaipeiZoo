...
class ArenaAdapter(
    ...
    override fun getDataAtPosition(position: Int): CommonItem = CommonItem(arenaList[position])
    ...
    override fun setOnClickLnr(view: View, data: Any) {
        view.setOnClickListener {
            ...
            intent.putExtra(INTENT_EXTRA_KEY_ARENA, (data as CommonItem).ejectKernel() as Arena)
